...
<?php include('session.php'); ?>    
	...
	<hr>
	Program:<input name="birthdate" type="text" value="<?php echo $row['birthdate']; ?>">
	<hr>
	School:<input name="address" type="text" value="<?php echo $row['address']; ?>">
	<hr>
	Department:<input name="status" type="text" value="<?php echo $row['status']; ?>">
	<hr>
	Mobile:<input name="mobile" type="text" value="<?php echo $row['mobile']; ?>">
	<hr>
	Registration Number:<input name="work" type="text" value="<?php echo $row['work']; ?>">
	<hr>
	Email:<input name="religion" type="text" value="<?php echo $row['religion']; ?>">
	<hr>
	<br>
			<center>
