  ...
  <div class="container">
    ...
    <nav class="collapse navbar-collapse" role="navigation">
      <ul class="nav navbar-nav">
        ...
        <li><a href="photos.php"><i class="icon-picture"></i>Resources</a></li>
        <li><a href="friends.php"><i class="icon-group"></i> Friends</a></li>
		<li><a href="message.php"><i class="icon-group"></i>Discussion</a>
        </li>
        <li>
		...
		<div class="pull-right">
            <form class="form-inline" method="post" action="search.php">
             <input type="text" name="search" class="form-control"  id="span5" placeholder="Search for Users">
            </form>
		</div>
